...
double MockPenmanData::delta() const { return Atmosphere::saturatedVapourPressure_slope(air_temperature()); };
double MockPenmanData::air_density() const { return Atmosphere::air_density(air_temperature(),vapour_pressure(),P_atm);};
double MockPenmanData::gamma() const { return Atmosphere::psychrometric_constant(P_atm,air_temperature(),heat_capacity_air());};
double MockPenmanData::lambda() const { return  Atmosphere::latent_heat_vapour_air(air_temperature());};
