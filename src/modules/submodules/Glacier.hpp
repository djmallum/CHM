...
namespace Glacier
{
	...
	struct Params
	{
        ...
        Units::DensitySI small_increment{25.0};
        Units::DensitySI big_increment{50.0};
        Units::DensitySI critical_density{550.0};
        Units::DensitySI firn_to_ice_density{830.0};
    ...
    {
    public:
        using Height = Units::Metres;
        using Density = Units::DensitySI;
    ...
    public:
        ...
        std::optional<Units::Milimetres> convert_to_ice(const Units::Kelvin T,
